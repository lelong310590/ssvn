                    ...
                    <div class="box-dropdown-single pull-left">
                        ...
                        <div class="pull-left dropdown-single">
                            <select class="show-txt" name="order">
                                <option value="0" <?php if(isset($_REQUEST['order'])&&$_REQUEST['order']==0){echo 'selected';}?>>Tham gia gần đây</option>
                                <option value="1" <?php if(isset($_REQUEST['order'])&&$_REQUEST['order']==1){echo 'selected';}?>>Tiêu đề Khóa đào tạo(A-Z)</option>
                                <option value="2" <?php if(isset($_REQUEST['order'])&&$_REQUEST['order']==2){echo 'selected';}?>>Tiến độ Khóa đào tạo(Z-A)</option>
                                <option value="3" <?php if(isset($_REQUEST['order'])&&$_REQUEST['order']==3){echo 'selected';}?>>Hoàn thành (0%-100%)</option>
                                <option value="4" <?php if(isset($_REQUEST['order'])&&$_REQUEST['order']==4){echo 'selected';}?>>Hoàn thành (100%-0%</option>
                            </select>
