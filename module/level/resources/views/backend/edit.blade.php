					...
					<div class="col-sm-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Sửa trình độ
									<a href="{{route('nqadmin::level.index.get')}}" class="btn btn-primary pull-right">
										<i class="fa fa-list-ol" aria-hidden="true"></i> Danh sách trình độ
									</a>
								</h5>
							</div>
							<div class="card-body">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<select class="custom-select form-control" name="featured">
									<option value="active" {{ ($data->featured == 'active') ? 'selected' : '' }}>Bật</option>
									<option value="disable" {{ ($data->featured == 'disable') ? 'selected' : '' }}>Tắt</option>
								</select>
								<div class="form-group">
