...
<div class="main-page">
            ...
            <div class="main-search">
                ...
                <div class="content">
                    ...
                    <div class="box-btn text-center">
                        <a href="{{(Auth::check()) ? route('front.course.create.get') : '#login-box'}}" class="btn btn-default-yellow btn-small btn-popup">Trở thành giảng viên của chúng tôi</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="box-form">
        <div class="container text-center">
            <div class="main-form">
                <h2 class="txt-title">Bạn đã sẵn sàng để kết nối?</h2>
                <p class="note">Hãy cho chúng tôi biết chủ đề bạn mong muốn giảng dạy</p>
                <div class="content-form">
                    <form class="box-form-default">
                        <div class="form-group">
                            <input type="text" placeholder="Chủ đề bạn muốn đăng ký giảng dậy" class="txt-form text-left pull-left">
                            <input type="submit" class="btn btn-default-yellow" value="Tạo chủ đề">
                        </div>
                    </form>
                </div>
            </div>
