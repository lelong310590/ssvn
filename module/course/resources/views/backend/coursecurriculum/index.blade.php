...
@section('content')
	<div class="wrapper-content">
		<form method="post" action="{{route('nqadmin::course.curriculum.post', $course->id)}}" enctype="multipart/form-data">
			{{csrf_field()}}
					...
					<div class="col-sm-13">
						<div class="card">
							...
							<div class="card-body">
								...
								@include('nqadmin-course::backend.components.coursecurriculum.index')
							</div>
						</div>
					</div>
				</div>
