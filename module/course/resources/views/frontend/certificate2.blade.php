    ...
    <div class="certificate">
        ...
        <div class="certificate-main">
            ...
            <div class="certificate-info">
                ...
                @if ($type == 'personal')
                    <p>Chứng nhận: <b style="margin-left: 25px">{{$user->sex == 'Nam' ? 'Ông' : 'Bà'}} {{$user->first_name}} {{$user->last_name}}</b></p>
                    ...
                    @endif
                @else
                    <p>Chứng nhận đơn vị: <b style="margin-left: 25px">{{$company != null ? $company->name : ''}}</b></p>
                    <p>Địa chỉ: <b style="margin-left: 25px">{{$company->fulladdress}}</b></p>
                @endif
