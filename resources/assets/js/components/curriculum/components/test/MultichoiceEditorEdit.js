...
class MultichoiceEditorEdit extends Component
{
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentWillMount() {
        ...
        this.setState({
            check: (_.isNull(answer.answer)) ? '' : answer.answer,
            content: (_.isNull(answer.content)) ? '' : answer.content,
            index: index
        })
    }
                ...
                <div className="answer-check">
                    <label className="custom-control custom-radio">
                        <input
                            ...
                            name="answer"
                            defaultChecked={answer.answer ===  'Y'}
                            value={answer || ''}
...
export default MultichoiceEditorEdit;